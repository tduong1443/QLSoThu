...
namespace QuanLiSoThu
{
    public partial class BaoCao : Form
    {
        ...
        {
            BaoCaoDSLoaiSD baoCaoDS = new BaoCaoDSLoaiSD();
            baoCaoDS.Show();
           
        }

        private void btnDSThuOm_Click(object sender, EventArgs e)
        {
            DSThuOm ds = new DSThuOm();
            ds.Show();
        }

        private void btnThongTinThu_Click(object sender, EventArgs e)
        {
            ThongTinThu tt = new ThongTinThu();
            tt.Show();
        }
    }
}
