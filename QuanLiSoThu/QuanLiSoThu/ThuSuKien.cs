...
namespace QuanLiSoThu
{
    public partial class ThuSuKien : Form
    {
        ...
        private void LoadDL()
        {
            ...
            dgvThuSK.RowTemplate.Height = 50;
        }
        ...
        {
            string queryInsert = $"INSERT INTO Thu_SuKien (MaSK, MaThu, NgayBD, NgayKT, TenLD, CachKP) VALUES (N'{maSK}', N'{maThu}', '{ngayBD}', '{ngayKT}', N'{maLD}', N'{maKP}')";
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            ...
            string query = $"UPDATE Thu_SuKien SET NgayBD = '{dtpNgayBD.Value}', NgayKT = '{dtpNgayKT.Value}'," +
                $" TenLD = N'{txtMaLD.Text}', CachKP = N'{txtMaKP.Text}' WHERE MaSK = N'{cboxMaSK.Text}' AND MaThu = N'{cboxMaThu.Text}'";
