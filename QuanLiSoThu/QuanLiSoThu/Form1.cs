    ...
    public partial class Form1 : Form
    {
        ...
        private void ActivateButton(object senderBtn, Color color)
        {
            if (senderBtn != null)
            {
                ...
                ipbHome.IconChar = currentBtn.IconChar;
                ipbHome.IconColor = color;
            }
        }
        ...
        private void Reset()
        {
            ...
            ipbHome.IconColor = Color.MediumPurple;
            lblFormCon.Text = "Home";
        }
        ...
        {
            ActivateButton(btnQLThu, RGBColors.color2);
            MoFile(new Thu());
        }

        private void btnChiTietChuong_Click(object sender, EventArgs e)
        {
            ActivateButton(btnQLChuong, RGBColors.color3);
            MoFile(new Chuong());
        }

        private void btnChiTietTA_Click(object sender, EventArgs e)
        {
            ActivateButton(btnQLThucAn, RGBColors.color4);
            MoFile(new ThucAn());
        }

        private void btnChiTietNV_Click(object sender, EventArgs e)
        {
            ActivateButton(btnQLNhanVien, RGBColors.color6);
            MoFile(new NhanVien());
        }
    }
}
