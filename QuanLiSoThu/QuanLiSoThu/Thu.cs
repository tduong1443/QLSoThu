...
namespace QuanLiSoThu
{
    public partial class Thu : Form
    {
        ...
        private void LoadData()
        {
            ...
            dgvThu.RowTemplate.Height = 80; // Đặt độ cao mặc định cho tất cả các dòng
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
            ...
            {
                if (txtNguonGoc.Text == "" || txtTenThu.Text == "" || txtDacDiem.Text == ""
                    || txtSoLuong.Text == "" || cbLoai.Text == "" || cbSachDo.Text == ""
                    || cbKieuSinh.Text == "" || txtTenKH.Text == "" || txtTenTA.Text == "" || txtTenTV.Text == ""
                    || txtTuoiTho.Text == "" || pbThu.Image == null)
                {
